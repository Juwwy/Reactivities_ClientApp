...
const [editMode, setEditMode] = useState(false);
 ...
 function handleDeleActivity(id:string){
  ...
  return (
    <Fragment >
      ...
      <Container style={{marginTop: '7em'}}>
        ...
        editMode={editMode} openForm={handleFormOpen} closeForm={handleFormClose} createOrEdit={handleCreateOrEditActivity}
        deleteActivity={handleDeleActivity}/>
      </Container>
    </Fragment>
  );
}
